 ...
 */
#ifndef LIBBITCOIN_CONSENSUS_HASH_HPP
#define LIBBITCOIN_CONSENSUS_HASH_HPP
 ...
 * ripemd160(data)
 */
BCX_API short_hash ripemd160_hash(data_slice data);
 ...
 * sha1(data)
 */
BCX_API short_hash sha1_hash(data_slice data);
 ...
 * sha256(data)
 */
BCX_API hash_digest sha256_hash(data_slice data);
 ...
 * sha256(data)
 */
BCX_API hash_digest sha256_hash(data_slice first, data_slice second);
 ...
 */
BCX_API hash_digest hmac_sha256_hash(data_slice data, data_slice key);
 ...
 * sha512(data)
 */
BCX_API long_hash sha512_hash(data_slice data);
 ...
 */
BCX_API long_hash hmac_sha512_hash(data_slice data, data_slice key);
 ...
 * sha256(sha256(data))
 */
BCX_API hash_digest bitcoin_hash(data_slice data);
 ...
 */
BCX_API short_hash bitcoin_short_hash(data_slice data);

// Make hash_digest and short_hash hashable for std::*map variants
template <typename HashType>
struct BCX_API std_hash_wrapper
{
...
namespace std
{
    ...
    template <>
    struct BCX_API hash<short_hash>
      : public std_hash_wrapper<short_hash>
    {
    };

    template <>
    struct BCX_API hash<hash_digest>
      : public std_hash_wrapper<hash_digest>
    {
    };

    template <>
    struct BCX_API hash<long_hash>
